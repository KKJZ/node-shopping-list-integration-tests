...
describe("Recipes", function(){
  ...
  it("should list recipes on GET", function() {
    ...
    .then(function(res) {
      ...
      res.body.forEach(function(item) {
        expect(item).to.be.a('object');
        expect(item).to.include.key(expectedKeys);
      })
    })
  });
  ...
  it("should add new recipes on POST", function() {
    ...
    .then(function(res) {
      ...
      expect(res).to.be.json;
      expect(res.body).to.be.a('object');
      expect(res.body).to.include.key('id','name','ingredients');
      expect(res.body.id).to.not.equal(null);
  ...
  it("should be able to update recipes with their ids on PUT", function() {
    const updateData = {
      name: 'foo',
      ingredients: ['bar','foobar']
    };
    return chai.request(app)
    .get('/recipes')
    .then(function(res) {
  ...
  it("should be able to delete on DELETE", function(){
    return chai.request(app)
    .get('/recipes')
    .then(function(res) {
